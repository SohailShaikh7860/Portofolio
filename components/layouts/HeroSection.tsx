    ...
    <section className="w-full flex flex-col justify-center items-center pt-10 sm:pt-20 px-4 sm:px-8 py-8">
      <div className="flex flex-col-reverse sm:flex-row justify-center items-center gap-4 sm:gap-8 w-full max-w-6xl" id="home">
        <div className="text-white flex flex-col items-center sm:items-start text-center sm:text-left">
          ...
          <p className="pt-2 text-base sm:text-lg md:text-xl text-gray-300">
      ...
      <div className="text-white mt-8 sm:mt-12 max-w-2xl w-full px-4">
      ...
      <div className="text-white mt-8 sm:mt-12 max-w-2xl w-full px-4">
        ...
        <div className="relative bg-gradient-to-r from-gray-900 to-black border border-gray-800 rounded-lg p-4 sm:p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-gray-700">
          ...
          <div className="flex flex-col gap-3 mb-3">
            ...
            <div className="text-left sm:text-right">
              <span className="inline-block bg-gray-800 text-gray-300 px-3 py-1 rounded-lg text-xs sm:text-sm font-medium">
                2023 - 2026
              </span>
            </div>
          </div>
        ...
        <div className="text-white mt-8 sm:mt-12 w-full">
          ...
          {Object.entries(skills).map(([category, skillList]) => (
            ...
            >
              <h4 className="text-sm sm:text-lg font-semibold capitalize text-gray-400 sm:min-w-[100px] pt-2">
                {category}:
              </h4>
              ...
              <div className="flex flex-wrap gap-2">
                {skillList.map((skill) => (
                  <Button
                    key={skill}
                    variant="outline"
                    className="text-xs sm:text-sm bg-blue-500 hover:bg-blue-600 border-blue-600"
                  >
                    {skill}
                  </Button>
                ))}
